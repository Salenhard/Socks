...
public class SockController {
    ...
    private final String TEMP_STORAGE = "/temp";


    @PostMapping("/income")
    public ResponseEntity<?> income(@RequestBody @Valid SockDto dto) {
        Sock sock = sockMapper.toEntity(dto);
        return ResponseEntity.ok(sockMapper.toDto(sockService.income(sock)));
    }

    @PostMapping("/outcome")
    public ResponseEntity<?> outcome(@RequestBody @Valid SockDto dto) {
        Sock sock = sockMapper.toEntity(dto);
    ...
    public ResponseEntity<List<SockDto>> getAll(@RequestParam(required = false) String color,
        ...
        List<Sock> socks = sockService.getAll(color, moreThenCotton, lessThenCotton, equalCotton, sort);
    ...
    @PostMapping
    public ResponseEntity<?> save(@RequestBody @Valid SockDto dto) {
    ...
    @PutMapping
    public ResponseEntity<?> update(@RequestBody Long id, @RequestBody @Valid SockDto dto) {
